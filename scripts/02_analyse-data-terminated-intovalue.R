# This scrips get historical entries for Intovalue terminated trials
# generates variable for duration of enrollment: start_date, stop_date
# generates variable for summary results availability ClinicalTrials.gov: has_summary_results_ctgov
# generates variable for degree of enrollment: anticipated_enrollment, actual_enrollment
# generates variable for reason for termination : why_stopped
...
iv_terminated_cthist <- read.csv(here::here("data","processed_dataset","intovalue", "intovalue_cthist.csv"))
